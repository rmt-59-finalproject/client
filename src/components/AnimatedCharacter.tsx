...
export default function AnimatedCharacter() {
  ...
  return (
    <div className="relative w-[200px] h-[200px] mx-auto mb-4 rounded-full">
      <div className="relative w-full h-0 overflow-hidden rounded-full pb-[100%]">
        <svg
          ref={svgRef}
      ...
      <div className="absolute top-0 left-0 w-full h-full rounded-full border-[2.5px] border-[#3a5e77] box-border"></div>
    </div>
  )
}